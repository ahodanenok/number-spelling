...
public class NumberSpelling_Acc_Plural_Test {

    private NumberSpelling spelling = new NumberSpelling();
    private SpellingContext context = SpellingContext.builder().withCase(Case.ACCUSATIVE).withCount(Count.PLURAL).build();
