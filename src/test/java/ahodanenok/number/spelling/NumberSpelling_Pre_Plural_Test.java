...
public class NumberSpelling_Pre_Plural_Test {

    private NumberSpelling spelling = new NumberSpelling();
    private SpellingContext context = SpellingContext.builder().withCase(Case.PREPOSITIONAL).withCount(Count.PLURAL).build();

    @Test
    public void check_00x() {
        Assertions.assertEquals("нолях", spelling.generate(0, context));
        Assertions.assertEquals("одних", spelling.generate(1, context));
    ...
    public void check_02x() {
        ...
        Assertions.assertEquals("двадцати одних", spelling.generate(21, context));
    ...
    public void check_03x() {
        ...
        Assertions.assertEquals("тридцати одних", spelling.generate(31, context));
    ...
    public void check_04x() {
        ...
        Assertions.assertEquals("сорока одних", spelling.generate(41, context));
    ...
    public void check_05x() {
        ...
        Assertions.assertEquals("пятидесяти одних", spelling.generate(51, context));
    ...
    public void check_06x() {
        ...
        Assertions.assertEquals("шестидесяти одних", spelling.generate(61, context));
    ...
    public void check_07x() {
        ...
        Assertions.assertEquals("семидесяти одних", spelling.generate(71, context));
    ...
    public void check_08x() {
        ...
        Assertions.assertEquals("восьмидесяти одних", spelling.generate(81, context));
    ...
    public void check_09x() {
        ...
        Assertions.assertEquals("девяноста одних", spelling.generate(91, context));
    ...
    public void check_10x() {
        ...
        Assertions.assertEquals("ста одних", spelling.generate(101, context));
    ...
    public void check_12x() {
        ...
        Assertions.assertEquals("ста двадцати одних", spelling.generate(121, context));
    ...
    public void check_15x() {
        ...
        Assertions.assertEquals("ста пятидесяти одних", spelling.generate(151, context));
    ...
    public void check_20x() {
        ...
        Assertions.assertEquals("двухстах одних", spelling.generate(201, context));
    ...
    public void check_22x() {
        ...
        Assertions.assertEquals("двухстах двадцати одних", spelling.generate(221, context));
    ...
    public void check_25x() {
        ...
        Assertions.assertEquals("двухстах пятидесяти одних", spelling.generate(251, context));
    ...
    public void check_30x() {
        ...
        Assertions.assertEquals("трёхстах одних", spelling.generate(301, context));
    ...
    public void check_32x() {
        ...
        Assertions.assertEquals("трёхстах двадцати одних", spelling.generate(321, context));
    ...
    public void check_35x() {
        ...
        Assertions.assertEquals("трёхстах пятидесяти одних", spelling.generate(351, context));
    ...
    public void check_40x() {
        ...
        Assertions.assertEquals("четырёхстах одних", spelling.generate(401, context));
    ...
    public void check_42x() {
        ...
        Assertions.assertEquals("четырёхстах двадцати одних", spelling.generate(421, context));
    ...
    public void check_45x() {
        ...
        Assertions.assertEquals("четырёхстах пятидесяти одних", spelling.generate(451, context));
    ...
    public void check_50x() {
        ...
        Assertions.assertEquals("пятистах одних", spelling.generate(501, context));
    ...
    public void check_52x() {
        ...
        Assertions.assertEquals("пятистах двадцати одних", spelling.generate(521, context));
    ...
    public void check_55x() {
        ...
        Assertions.assertEquals("пятистах пятидесяти одних", spelling.generate(551, context));
    ...
    public void check_60x() {
        ...
        Assertions.assertEquals("шестистах одних", spelling.generate(601, context));
    ...
    public void check_62x() {
        ...
        Assertions.assertEquals("шестистах двадцати одних", spelling.generate(621, context));
    ...
    public void check_65x() {
        ...
        Assertions.assertEquals("шестистах пятидесяти одних", spelling.generate(651, context));
    ...
    public void check_70x() {
        ...
        Assertions.assertEquals("семистах одних", spelling.generate(701, context));
    ...
    public void check_72x() {
        ...
        Assertions.assertEquals("семистах двадцати одних", spelling.generate(721, context));
    ...
    public void check_75x() {
        ...
        Assertions.assertEquals("семистах пятидесяти одних", spelling.generate(751, context));
    ...
    public void check_80x() {
        ...
        Assertions.assertEquals("восьмистах одних", spelling.generate(801, context));
    ...
    public void check_82x() {
        ...
        Assertions.assertEquals("восьмистах двадцати одних", spelling.generate(821, context));
    ...
    public void check_85x() {
        ...
        Assertions.assertEquals("восьмистах пятидесяти одних", spelling.generate(851, context));
    ...
    public void check_90x() {
        ...
        Assertions.assertEquals("девятистах одних", spelling.generate(901, context));
    ...
    public void check_92x() {
        ...
        Assertions.assertEquals("девятистах двадцати одних", spelling.generate(921, context));
    ...
    public void check_95x() {
        ...
        Assertions.assertEquals("девятистах пятидесяти одних", spelling.generate(951, context));
