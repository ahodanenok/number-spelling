...
public class NumberSpelling_Inst_Trillion_Test {
    ...
    public void check_x_000_000_000_000_Plural() {
        ...
        assertEquals("одними триллионами", spelling.generate(1_000_000_000_000L, pluralContext));
        assertEquals("двумя триллионами", spelling.generate(2_000_000_000_000L, pluralContext));
        assertEquals("тремя триллионами", spelling.generate(3_000_000_000_000L, pluralContext));
        assertEquals("четырьмя триллионами", spelling.generate(4_000_000_000_000L, pluralContext));
        assertEquals("пятью триллионами", spelling.generate(5_000_000_000_000L, pluralContext));
        assertEquals("шестью триллионами", spelling.generate(6_000_000_000_000L, pluralContext));
        assertEquals("семью триллионами", spelling.generate(7_000_000_000_000L, pluralContext));
        assertEquals("восьмью триллионами", spelling.generate(8_000_000_000_000L, pluralContext));
        assertEquals("девятью триллионами", spelling.generate(9_000_000_000_000L, pluralContext));
    }
